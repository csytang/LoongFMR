  ...
  throws Exception
{
  ...
  //preferences_d = (BunchPreferences)(Beans.instantiate(null, "bunch.BunchPreferences"));
	preferences_d = new BunchPreferences();
...
clusteringOptionsButton_d_actionPerformed(ActionEvent e)
{
  ...
  try {
   ...
   // dlg = new ClusteringConfigurationDialog();
   switch(clusteringMethod_d.getConfigurationDialogName()){
	   case "bunch.HillClimbingClusteringConfigurationDialog":{
		   dlg = new HillClimbingClusteringConfigurationDialog();
		   break;
	   }
	   case "bunch.GAClusteringConfigurationDialog":{
		   dlg = new GAClusteringConfigurationDialog();
		   break;
	   }
	   case "bunch.NAHCClusteringConfigurationDialog":{
		   dlg = new NAHCClusteringConfigurationDialog();
	   }
   }
	 dlg.setModal(true);
