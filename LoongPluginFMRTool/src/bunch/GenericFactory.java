...
public Object getItemInstance(String name)
{
  ...
  try {
	  switch(cls){
	  case "bunch.GeneralHillClimbingClusteringMethod":{
		  obj = new GeneralHillClimbingClusteringMethod();
		  
		  break;
	  }
	  case "bunch.GAClusteringMethod":{
		  obj = new GAClusteringMethod();
		  break;
	  }
...
public Object getItemInstanceFromClass(String cls)
{
  ...
  switch(cls){
  case "dependency":{
	  obj = new DependencyFileParser();
	  break;
  }
  case "gxl":{
	 // obj = new bunch.gxl.parser.GXLGraphParser();
	  break;
  }
  case "cluster":{
	  obj = new bunch.ClusterFileParser();
	  break;
  }
  case "Dotty":{
	  obj = new bunch.DotGraphOutput();
	  break;
  }
  case "Text":{
	  obj = new bunch.TXTGraphOutput();
	  break;
  }
  case "GXL":{
	 // obj = new bunch.gxl.io.GXLGraphOutput();
	  break;
  }
  /*
   ...
   */
  case "Incremental MQ Weighted":{
	  obj = new bunch.TurboMQIncrW();
	  break;
  }
  case "Basic MQ Function":{
	  obj = new bunch.BasicMQ();
	  break;
  }
  case "Turbo MQ Function":{
	  obj = new bunch.TurboMQ();
	  break;
  }
  case "Incremental MQ":{
	  obj = new bunch.TurboMQIncr();
	  break;
  }
  case "bunch.BasicMQ":{
	  obj = new bunch.BasicMQ();
