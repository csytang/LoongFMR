...
int [] prIfreq = new int [11];
 ...
 public void BunchAPITest4() {
     ...
     // bp.setProperty(BunchProperties.MDG_INPUT_FILE_NAME,"e:\\expir\\rcs");
      ...
      //bp.setProperty(BunchProperties.OUTPUT_FORMAT,BunchProperties.NULL_OUTPUT_FORMAT);
      bp.setProperty(BunchProperties.PROGRESS_CALLBACK_CLASS,"loongpluginfmrtool.toolbox.bunch.api.BunchAPITestCallback");
...
public void BunchAPITest1x()
{
  ...
  for(int i = 0; i < numRuns; i++)
  {
    ...
    if(useSA)
    {
      ...
      bp.setProperty(BunchProperties.ALG_HC_SA_CLASS, "loongpluginfmrtool.toolbox.bunch.SASimpleTechnique");
...
/*
      ...
      g = BunchGraphUtils.constructFromSil(mdg,sil,"loongpluginfmrtool.toolbox.bunch.BasicMQ");
      v = g.getMQValue();
      System.out.println("Basic Mq value= "+v);

      g = BunchGraphUtils.constructFromSil(mdg,sil,"loongpluginfmrtool.toolbox.bunch.TurboMQ");
      v = g.getMQValue();
      System.out.println("Turbo Mq value= "+v);

      g = BunchGraphUtils.constructFromSil(mdg,sil,"loongpluginfmrtool.toolbox.bunch.ITurboMQ");
      v = g.getMQValue();
 ...
 */
      ...
      //bp.setProperty(BunchProperties.MQ_CALCULATOR_CLASS,"loongpluginfmrtool.toolbox.bunch.TurboMQIncrW");
