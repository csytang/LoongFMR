...
public class BunchStatsTest {
  ...
  public void checkGraphTest()
  {
    try
    {
      ...
      BunchPreferences pref = (BunchPreferences)(java.beans.Beans.instantiate(null, "loongpluginfmrtool.toolbox.bunch.BunchPreferences"));
      ...
      String objFnCalc =  "loongpluginfmrtool.toolbox.bunch.TurboMQIncrW";
  ...
  try{
    ...
    for(int i = 0; i < 100; i++)
    {
      ...
      //bp.setProperty(BunchProperties.ALG_NAHC_SA_CLASS,"loongpluginfmrtool.toolbox.bunch.SASimpleTechnique");
