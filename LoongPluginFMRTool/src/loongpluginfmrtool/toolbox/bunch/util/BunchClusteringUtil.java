...
public class BunchClusteringUtil extends JDialog {
  ...
  void RunPB_actionPerformed(ActionEvent e) {
    ...
    BunchGraph g = loongpluginfmrtool.toolbox.bunch.api.BunchGraphUtils.constructFromSil(mdgFileNameEF.getText(),
    ...
    for(int i = 0; i < numClusters; i++)
    {
      ...
      double mqResult = loongpluginfmrtool.toolbox.bunch.util.MQCalculator.CalcMQ(mdg,outputSil,
