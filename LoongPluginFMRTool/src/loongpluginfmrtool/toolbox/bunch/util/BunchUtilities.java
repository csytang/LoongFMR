...
import loongpluginfmrtool.toolbox.bunch.util.ParserNode;
...
public static loongpluginfmrtool.toolbox.bunch.Graph toInternalGraph(loongpluginfmrtool.toolbox.bunch.api.BunchMDG bunchMDG)
{
  ...
  {
    loongpluginfmrtool.toolbox.bunch.api.BunchMDGDependency bmd = (loongpluginfmrtool.toolbox.bunch.api.BunchMDGDependency)al.get(i);
